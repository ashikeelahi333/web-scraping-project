...
const country = teamIdList[0]; // 0 for first team
  ...
  async function getData(URL) {
    try {
      ...
      matchData.each(async (index, element) => {
        ...
        await console.log(detailObj);
        await console.log(matchList.length)
